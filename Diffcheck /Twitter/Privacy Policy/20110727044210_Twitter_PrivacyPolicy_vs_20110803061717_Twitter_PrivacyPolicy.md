...
give you settings (http<span style="background-color: green;">s</span>://twitter.com/account/settings) to make the information more private if you want. Your public information is broadly and
...
settings (http<span style="background-color: green;">s</span>://twitter.com/account/settings).
