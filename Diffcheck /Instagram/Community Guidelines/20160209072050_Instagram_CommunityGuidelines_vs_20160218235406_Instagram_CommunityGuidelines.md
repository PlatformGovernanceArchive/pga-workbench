...
region)<span style="background-color: green;"> is also not allowed</span>. Remember to always follow the law when offering to sell or buy other<span style="background-color: red;"> </span><span style="background-color: green;">

</span>regulated goods.<span style="background-color: green;"> </span><span style="background-color: red;">

</span>Accounts promoting online gambling, online real money games of skill or online<span style="background-color: red;"> lotteries must get</span>

<span style="background-color: green;">lotteries must get </span>our prior written permission before using any of our products.
