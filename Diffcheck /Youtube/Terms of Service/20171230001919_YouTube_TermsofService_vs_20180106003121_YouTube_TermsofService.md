...
the Embeddable Player, including but not limited to links back to the YouTube website.<span style="background-color: green;">
...
repeat infringer.<span style="background-color: green;">
</span>
...
WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF OUR SERVICES, (III) ANY UNAUTHORIZED ACCESS TO OR<span style="background-color: green;">
