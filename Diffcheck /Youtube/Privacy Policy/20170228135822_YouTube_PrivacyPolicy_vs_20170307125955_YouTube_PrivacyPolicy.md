...
Last modified: <span style="background-color: green;">March</span><span style="background-color: red;">August</span> <span style="background-color: green;">1</span><span style="background-color: red;">29</span>, 201<span style="background-color: red;">6</span><span style="background-color: green;">7</span> (view archived versions)
...
If your Google Account is managed for you by a domain administrator (for example, for G<span style="background-color: green;"> Suite users) then your domain administrator


and resellers who provide user support to your organization will have access to your G</span>oogle A<span style="background-color: red;">pps users) then your domain


administrator and resellers who provide user support to your organization will have a</span>cc<span style="background-color: red;">ess t</span>o<span style="background-color: red;"> yo</span>u<span style="background-color: red;">r Google Accou</span>nt information<span style="background-color: green;"> </span><span style="background-color: red;">
...
G<span style="background-color: red;">oogle</span> <span style="background-color: red;">Apps</span><span style="background-color: green;">Suite</span> for Education
