...
Last modified: <span style="background-color: red;">J</span><span style="background-color: green;">A</span>u<span style="background-color: red;">ne</span><span style="background-color: green;">gust</span> 2<span style="background-color: red;">8</span><span style="background-color: green;">9</span>, 2016 (view archived versions)
...
interest you, using Ads Settings. You can also <span style="background-color: green;">visit that page to </span>opt out of certain Google advertising services<span style="background-color: red;"> here</span>.
...
We regularly review our compliance with our Privacy Policy. We also adhere to several self regulatory frameworks<span style="background-color: green;">, including the EU-US


Privacy Shield Framework</span>. When we receive formal<span style="background-color: green;"> </span><span style="background-color: red;">


</span>written complaints, we will contact the person who made the complaint to follow up. We<span style="background-color: red;"> </span><span style="background-color: green;">


</span>work with the appropriate regulatory authorities,<span style="background-color: green;"> </span><span style="background-color: red;">


</span>including local data protection authorities, to resolve any complaints regarding the transfer<span style="background-color: red;"> of personal data that we cannot resolve with our</span>


<span style="background-color: green;">of personal data that we cannot resolve with our </span>users directly.
