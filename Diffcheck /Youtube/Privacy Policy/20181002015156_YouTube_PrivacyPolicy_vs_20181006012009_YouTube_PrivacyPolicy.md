...
**<span style="background-color: green;">Ac</span><span style="background-color: red;">504 Ga</span>t<span style="background-color: red;">eway T</span>i<span style="background-color: green;">vi</span><span style="background-color: red;">me-ou</span>t<span style="background-color: green;">y Controls</span>**


<span style="background-color: red;">ng</span><span style="background-color: green;">Dec</span>i<span style="background-color: green;">de what types of activity you’d like saved i</span>n<span style="background-color: green;"> your account. For e</span>x<span style="background-color: red;">/1</span><span style="background-color: green;">ample, you can turn on Location History if you want traffic


predictions for your daily commute, or you can save your YouTube Watch History to get better video suggestions</span>.<span style="background-color: red;">19</span><span style="background-color: green;">
...
Manage your preferences about the ads shown to you on Google and on sites and apps that partner with Google to show ads</span>.<span style="background-color: red;">5</span><span style="background-color: green;"> You can</span>


<span style="background-color: green;">modify your interests, choose whether your personal information is used to make ads more relevant to you, and turn on or off certain
