...
Privacy Shield Framework. When we receive formal written complaints, we will contact the person who made the complaint to follow up.<span style="background-color: red;"> </span><span style="background-color: green;">
...
</span>work with the appropriate regulatory authorities, including local data protection authorities, to resolve any complaints regarding the<span style="background-color: red;"> transfer</span>


<span style="background-color: green;">transfer </span>of personal data that we cannot resolve with our users directly.
