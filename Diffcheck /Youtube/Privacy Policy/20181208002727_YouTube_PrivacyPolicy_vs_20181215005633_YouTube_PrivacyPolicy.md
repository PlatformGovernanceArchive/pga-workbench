...
Your apps, browsers & devices<span style="background-color: red;">
</span>
...
Chrome browsing history you’ve synced with your Google Account<span style="background-color: red;">
</span>
...
<span style="background-color: green;">
W</span><span style="background-color: red;">application data cach</span>e<span style="background-color: green;"> u</span>s<span style="background-color: green;">e various technologies to collect and store information</span>, <span style="background-color: green;">inclu</span>d<span style="background-color: red;">a</span><span style="background-color: green;">ing cookies, pixel </span>ta<span style="background-color: green;">gs, local storage, such as </span>b<span style="background-color: red;">a</span><span style="background-color: green;">row</span>s<span style="background-color: green;">er web storage or


application data cach</span>es, <span style="background-color: green;">databases, </span>and server logs.<span style="background-color: red;">
</span>
...
<span style="background-color: green;">
</span>phone number with the flower shop.<span style="background-color: red;">
</span>
...
</span>in our products — you can learn more in our Product Privacy Guide.<span style="background-color: red;">
</span>
...
</span>My Activity allows you to review and control data that’s created when you use Google services, like searches you’ve done or your visits to
...
</span>Search for and then delete specific items from your account using My Activity<span style="background-color: red;">
...
This Privacy Policy doesn’t apply to:<span style="background-color: red;">
</span>
...
<span style="background-color: green;">
Privacy & </span>Te<span style="background-color: green;">rm</span><span style="background-color: red;">chnologie</span>s <span style="background-color: red;">an</span><span style="background-color: green;">provi</span>d<span style="background-color: green;">es more context regarding this</span> Pri<span style="background-color: green;">vacy Policy and our Terms of Service


Technologies and Pri</span>nciples includes more information about:
...
</span>A<span style="background-color: green;"> pa</span><span style="background-color: red;">dvertisin</span>g<span style="background-color: green;">e that explains what data is shared with Google when you visit websites that use our advertising, analytics and social
