...
Last modified: <span style="background-color: green;">M</span><span style="background-color: red;">Febru</span>a<span style="background-color: red;">r</span>y <span style="background-color: green;">1</span><span style="background-color: red;">25</span>, 2015 (view archived versions)
...
**linked, <span style="background-color: red;">using</span><span style="background-color: green;">by the</span> Google**


**<span style="background-color: green;">Analytics customer or by Google, using Google </span>technology, with information about visits to multiple sites**.
