...
There are other way</span>s<span style="background-color: green;"> to control the information Google collects whether or not you’re signed in to a Google Account</span>, <span style="background-color: red;">or </span>in<span style="background-color: green;">c</span><span style="background-color: red;">dividua</span>l<span style="background-color: red;">s o</span>u<span style="background-color: red;">tsi</span>d<span style="background-color: red;">e </span><span style="background-color: green;">ing:


Br</span>o<span style="background-color: green;">wser settings: For example, you can con</span>f<span style="background-color: green;">igure your browser to indicate when</span> Google <span style="background-color: green;">has set a cookie in your browser. You can
