...
Any content containing statements of intent, calls for action,<span style="background-color: green;"> </span>conditional or 

aspirational statements, or advocating for<span style="background-color: red;"> </span> violence due to voting, voter registration, 
...
</span>Threats against election officials<span style="background-color: red;"> 
...
murders, serial murders,<span style="background-color: green;"> </span>hate crimes and violating events.<span style="background-color: green;"> 

</span>We do not allow the <span style="background-color: red;">

</span>following groups to maintain a Page, Group, Event or IG profile <span style="background-color: red;">on our platform, or to </span>

<span style="background-color: green;">on our platform, or to </span>have one maintained on their behalf. The Admins of these <span style="background-color: green;">

</span>Pages, Groups and <span style="background-color: red;">
...
<span style="background-color: green;">*Click here to read more about how we address movements and organizations tied to* 
...
</span>**I. Violence and Criminal Behavior**<span style="background-color: green;"> 
...
Speaks positively, coordinates or encourages the poaching of <span style="background-color: red;">of </span>endangered 

species and their parts 

Provides instructions to use or make products from<span style="background-color: green;"> </span>endangered species and 
...
</span>For the following content, we restrict visibility to adults eighteen years of age and 
...
procedure<span style="background-color: red;"> 
...
</span>**6. Suicide and Self-Injury** 
...
suicide in a medical setting<span style="background-color: red;"> 
...
transmitted disease<span style="background-color: red;"> 
...
Content that praises, celebrates, or mocks their death<span style="background-color: red;"> 
...
Caricatures of <span style="background-color: red;">b</span><span style="background-color: green;">B</span>lack people in the form of blackface 
...
</span>Expressions of disgust (in written or visual form), which we define as: 
...
defined as words that are inherently offensive <span style="background-color: green;">and </span>used as insulting labels for the <span style="background-color: green;">

</span>above-<span style="background-color: red;">

</span>listed characteristics. 
...
to change people’s sexual orientation or gender identity<span style="background-color: red;"> 
