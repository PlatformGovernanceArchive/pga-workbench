...
English (US) <span style="background-color: green;">Português (Brasil) </span>Español Français (France) <span style="background-color: red;">中文(简体)</span><span style="background-color: green;">Italiano Deutsch</span>اﻟﻌرﺑﯾﺔ

<span style="background-color: green;">中文</span><span style="background-color: red;">Português </span>(<span style="background-color: green;">简体</span><span style="background-color: red;">Brasil</span>) <span style="background-color: red;">Italiano ��� Deutsch
