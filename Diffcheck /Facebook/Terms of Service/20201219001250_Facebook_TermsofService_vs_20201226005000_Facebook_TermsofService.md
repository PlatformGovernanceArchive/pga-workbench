...
Live Policies: These policies apply to all content broadcast to Facebook <span style="background-color: green;">Live.</span><span style="background-color: red;">through</span>

<span style="background-color: green;">Messaging services terms relevant for EU, EEA and UK users: terms applicable to the

messaging, voice and video calling services included in </span>Facebook <span style="background-color: red;">Liv</span><span style="background-color: green;">Products ar</span>e<span style="background-color: green;"> listed

here and here in accordance with EU rules</span>.
