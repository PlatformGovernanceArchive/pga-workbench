...
English (US) <span style="background-color: red;">Português (Brasil) </span>Español Français (France) <span style="background-color: green;">中文(简体)</span><span style="background-color: red;">Italiano Deutsch</span>اﻟﻌرﺑﯾﺔ

<span style="background-color: red;">中文</span><span style="background-color: green;">Português </span>(<span style="background-color: red;">简体</span><span style="background-color: green;">Brasil</span>) <span style="background-color: green;">Italiano ��� Deutsch
...
Facebook © 201<span style="background-color: red;">6</span><span style="background-color: green;">7</span>
