...
**<span style="background-color: green;">F</span><span style="background-color: red;">Public inf</span>or<span style="background-color: red;">m</span><span style="background-color: green;"> </span>a<span style="background-color: green;"> be</span>t<span style="background-color: green;">ter exper</span>i<span style="background-color: red;">o</span><span style="background-color: green;">e</span>n<span style="background-color: green;">ce on Facebook, enable JavaScript in your browser, or** **switch to our mobile site****.</span>**
