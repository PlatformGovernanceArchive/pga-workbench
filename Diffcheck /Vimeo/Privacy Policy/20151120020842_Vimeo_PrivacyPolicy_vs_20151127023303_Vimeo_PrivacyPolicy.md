...
<span style="background-color: green;">T</span><span style="background-color: red;">Developers can dive into o</span>ur<span style="background-color: red;"> API docume</span>n<span style="background-color: red;">tation</span> <span style="background-color: red;">f</span>o<span style="background-color: red;">r all Vimeo 1s a</span>n<span style="background-color: red;">d</span> <span style="background-color: red;">0</span><span style="background-color: green;">looping for your embedded video </span>s<span style="background-color: green;">o it will play over and over and over and over and over and…you get the
