...
You can <span style="background-color: red;">watc</span>h<span style="background-color: green;">elp keep</span> Vimeo <span style="background-color: green;">saf</span><span style="background-color: red;">on th</span>e <span style="background-color: red;">Vim</span><span style="background-color: green;">and cl</span>e<span style="background-color: green;">an</span><span style="background-color: red;">-go</span>.<span style="background-color: green;"> If you have concerns about something you see, use our flag system.</span>
