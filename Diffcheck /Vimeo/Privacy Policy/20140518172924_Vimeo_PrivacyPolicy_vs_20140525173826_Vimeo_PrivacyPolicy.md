...
<span style="background-color: green;">Y</span><span style="background-color: red;">We think it’s imp</span>o<span style="background-color: red;">rtant to have control over yo</span>u<span style="background-color: green;"> can send detailed missives o</span>r<span style="background-color: green;"> short notes to fellow</span> Vime<span style="background-color: green;">a</span><span style="background-color: red;">o co</span>n<span style="background-color: red;">nection</span>s<span style="background-color: green;"> using our private messaging system</span>.<span style="background-color: red;"> Learn more about Member Block.</span>
