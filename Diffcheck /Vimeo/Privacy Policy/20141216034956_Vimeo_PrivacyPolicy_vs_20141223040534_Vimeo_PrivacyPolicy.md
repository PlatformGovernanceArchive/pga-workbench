...
<span style="background-color: green;">L</span><span style="background-color: red;">You may alr</span>ea<span style="background-color: red;">dy own a sophisticated piece of filmmaking equipment: a ca</span>r<span style="background-color: green;">n how "dynamic range" and "latitude" apply to you, not just to pro cinematographers</span>.<span style="background-color: red;"> Learn to use it for some amazing shots.</span>
