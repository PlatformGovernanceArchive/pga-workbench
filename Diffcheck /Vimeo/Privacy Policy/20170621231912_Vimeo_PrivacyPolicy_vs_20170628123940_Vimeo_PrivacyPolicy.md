...
<span style="background-color: green;">H</span><span style="background-color: red;">Vim</span>e<span style="background-color: red;">o</span><span style="background-color: green;">y</span> <span style="background-color: green;">developers. We can meet your desires


Simple and Advanced APIs for all your app-


buildin</span>g<span style="background-color: red;">ives</span> <span style="background-color: red;">co</span>n<span style="background-color: red;">trol fr</span>e<span style="background-color: red;">aks th</span>e<span style="background-color: red;"> power to 


every aspect of their embe</span>d<span style="background-color: red;">ded video</span>s<span style="background-color: red;">: colors,


buttons, end screens, and more</span>.
