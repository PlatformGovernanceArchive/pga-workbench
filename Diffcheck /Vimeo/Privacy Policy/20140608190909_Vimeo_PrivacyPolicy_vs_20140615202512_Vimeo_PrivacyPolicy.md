...
<span style="background-color: red;">If you can’t get enough facts and figures, you can get the full picture of video performance with Advanced </span>S<span style="background-color: red;">t</span><span style="background-color: green;">oci</span>a<span style="background-color: green;">l bu</span>t<span style="background-color: green;">terflie</span>s<span style="background-color: green;"> can connect their Vimeo account to Facebook for easy sharing</span>.
