...
<span style="background-color: green;">We think organization is sexy. That’s why Vimeo lets you arrange videos into Albums, Channels, and Groups. </span>So<span style="background-color: red;">cial</span> <span style="background-color: red;">butterflies can connect their Vimeo account to Facebook for eas</span>y<span style="background-color: red;"> sh</span><span style="background-color: green;">ou


c</span>a<span style="background-color: red;">ri</span>n<span style="background-color: red;">g</span><span style="background-color: green;"> be sexy</span>.
