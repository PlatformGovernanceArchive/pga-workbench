...
<span style="background-color: green;">W</span><span style="background-color: red;">You can ta</span>i<span style="background-color: red;">lor your fee</span>d<span style="background-color: red;"> to your interests


by followin</span>g<span style="background-color: red;"> tags, such as “surfing” or


“tim</span>e<span style="background-color: green;">t</span><span style="background-color: red;">-lap</span>s<span style="background-color: green;"> ar</span>e<span style="background-color: green;"> nifty tools that make it easy


to publish and watch videos on other


sites</span>.<span style="background-color: red;">”</span><span style="background-color: green;"> Create a Widget.</span>
