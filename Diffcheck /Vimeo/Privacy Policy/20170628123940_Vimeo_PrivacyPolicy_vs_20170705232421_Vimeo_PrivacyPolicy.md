...
<span style="background-color: green;">Cu</span><span style="background-color: red;">Hey developer</span>s<span style="background-color: green;">tomize your video URL and send people to


vimeo</span>.<span style="background-color: red;"> We </span>c<span style="background-color: red;">an meet y</span>o<span style="background-color: red;">ur desires


Si</span>m<span style="background-color: green;">/m</span><span style="background-color: red;">ple and Advanced APIs for all </span>y<span style="background-color: red;">our app-


building need</span>s<span style="background-color: green;">weetvidname instead of
