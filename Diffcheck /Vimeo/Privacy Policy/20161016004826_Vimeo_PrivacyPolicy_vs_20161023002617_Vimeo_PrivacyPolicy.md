...
<span style="background-color: green;">DSLR</span><span style="background-color: red;">Add multiple email addre</span>s<span style="background-color: red;">ses</span> <span style="background-color: red;">to your Vimeo


</span>a<span style="background-color: red;">ccount (to maintain those multiple


pe</span>r<span style="background-color: red;">sonaliti</span>e<span style="background-color: green;"> powerful tool</span>s<span style="background-color: red;">)</span><span style="background-color: green;"> for video making, as
