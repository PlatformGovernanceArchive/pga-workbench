...
<span style="background-color: green;">W</span><span style="background-color: red;">Spruce up your v</span>id<span style="background-color: red;">eo pa</span>ge<span style="background-color: green;">ts are nifty tools that make it easy to publish and</span> w<span style="background-color: red;">ith production stills or r</span>a<span style="background-color: red;">ndom pho</span>t<span style="background-color: red;">os from your birthday party. Link straight from


Instagram or Fli</span>c<span style="background-color: red;">k</span><span style="background-color: green;">h videos on othe</span>r<span style="background-color: green;"> sites</span>.<span style="background-color: green;"> Create a Widget.</span>
