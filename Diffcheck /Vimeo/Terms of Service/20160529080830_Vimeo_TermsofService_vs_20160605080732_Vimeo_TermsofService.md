...
<span style="background-color: red;">C</span><span style="background-color: green;">J-c</span>u<span style="background-color: red;">rve</span><span style="background-color: green;">ts an</span>d<span style="background-color: green;"> L-cuts are named after the shape they make in your editing timeline. Pretty</span> w<span style="background-color: red;">alls are the new stra</span>i<span style="background-color: red;">ght wa</span>l<span style="background-color: red;">ls. Want a seamless backgroun</span>d<span style="background-color: green;">, right</span>?<span style="background-color: red;"> Get yourself an Infinity Wall!</span>
