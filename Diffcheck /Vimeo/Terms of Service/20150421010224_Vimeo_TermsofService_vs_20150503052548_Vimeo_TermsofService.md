...
<span style="background-color: green;">Ent</span><span style="background-color: red;">Curv</span>e<span style="background-color: red;">d</span><span style="background-color: green;">rtain</span> <span style="background-color: green;">your eyeballs — choose from over 8,000 films, docs, shorts, and series to stream or do</span>w<span style="background-color: red;">alls are the </span>n<span style="background-color: red;">ew straight wa</span>l<span style="background-color: red;">ls</span><span style="background-color: green;">oad on Vimeo


On Demand</span>.<span style="background-color: red;"> Want a seamless background? Get yourself an Infinity Wall!</span>
