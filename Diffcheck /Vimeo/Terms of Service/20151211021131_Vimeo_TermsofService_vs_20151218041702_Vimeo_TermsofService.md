...
<span style="background-color: green;">Social butterflies can connect their Vimeo


account to </span>F<span style="background-color: red;">ollow Vimeo on Twitter for import</span>a<span style="background-color: red;">nt


updates, witty quips, and Staff Pi</span>c<span style="background-color: green;">eboo</span>k<span style="background-color: red;">s,


complete</span> <span style="background-color: green;">for</span><span style="background-color: red;">with</span> <span style="background-color: green;">e</span><span style="background-color: red;">#h</span>as<span style="background-color: green;">y </span><span style="background-color: red;">htag</span>s<span style="background-color: green;">haring</span>.
