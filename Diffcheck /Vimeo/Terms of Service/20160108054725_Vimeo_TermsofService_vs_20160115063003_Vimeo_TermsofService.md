...
<span style="background-color: green;">A little planning and attention to your in-


camera settings can prevent you from ever


again saying "</span>We<span style="background-color: green;">’ll</span> <span style="background-color: green;">ju</span><span style="background-color: red;">think organization i</span>s<span style="background-color: green;">t</span> <span style="background-color: red;">se</span><span style="background-color: green;">fi</span>x<span style="background-color: red;">y</span><span style="background-color: green;"> that in post</span>.<span style="background-color: green;">​"</span><span style="background-color: red;"> That’s why


Vimeo lets you arrange videos into Albums,


Channels, and Groups. So you can be sexy.</span>
