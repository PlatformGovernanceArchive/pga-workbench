...
<span style="background-color: green;">Cu</span><span style="background-color: red;">Want to privately </span>s<span style="background-color: red;">har</span><span style="background-color: green;">tomiz</span>e <span style="background-color: green;">the color, buttons, </span>a<span style="background-color: green;">nd outro of your embedded</span> video with <span style="background-color: red;">a client or coworker? </span>Vimeo<span style="background-color: green;"> Plus and</span> PRO<span style="background-color: red;"> members can create unlisted Video
